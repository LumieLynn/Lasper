...
use crate::domain::bootstrap::{
    BootstrapSpec, DebootstrapDependencyMode, DebootstrapPolicy, DebootstrapReleaseSignaturePolicy,
    DebootstrapSpec, DebootstrapTransportPolicy, DebootstrapUsrMergeMode, Dnf5BestCandidatePolicy,
    Dnf5DocumentationPolicy, Dnf5MetadataMode, Dnf5PackageSignaturePolicy, Dnf5RepositorySource,
    Dnf5Spec, Dnf5WeakDependencyPolicy, PacmanKeyringMode, PacmanMirrorlistMode, PacstrapCacheMode,
...
mod tests {
    use super::*;
    use crate::domain::bootstrap::{Dnf5Policy, PacstrapPolicy};
