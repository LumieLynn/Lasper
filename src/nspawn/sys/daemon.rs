...
use crate::domain::secret::{zeroize_string, SecretBytes};
...
impl OutboundRpcRequest {
    ...
    fn into_wire_bytes(self) -> serde_json::Result<SecretBytes> {
        #[derive(Serialize)]
...
fn request_machine_name(params: &serde_json::Value) -> Result<MachineName, String> {
