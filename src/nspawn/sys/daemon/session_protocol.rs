...
#[serde(transparent)]
pub(super) struct WireSessionId(NonZeroU64);

impl WireSessionId {
    pub(super) fn new(value: u64) -> std::io::Result<Self> {
...
pub(super) struct SpawnJournalctlParams {
...
#[derive(Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(super) struct SpawnTerminalParams {
    pub session_id: WireSessionId,
    pub name: MachineName,
...
#[serde(deny_unknown_fields)]
pub(super) struct SpawnTerminalResponse {
    pub attach_kind: WireTerminalAttachmentKind,
}

#[derive(Clone, Copy, Debug, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub(super) enum WireTerminalAttachmentKind {
    Login,
    Namespace,
}
...
pub(super) enum WireSessionLifecycle {
