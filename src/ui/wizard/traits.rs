...
pub trait IStep {
    ...
    fn render(&mut self, f: &mut Frame, area: Rect, context: &super::WizardContext);
    
    /// Processes a key event for this step and returns the resulting action.
    async fn handle_key(&mut self, key: KeyEvent, context: &mut super::WizardContext) -> StepAction;
}
