...
impl Component for HelpOverlay {
    fn render(&mut self, f: &mut Frame, area: Rect) {
        ...
        let rows = vec![
            ...
            key_row("j / ↓", "Select next container", key_style, desc_style),
            key_row("k / ↑", "Select previous container", key_style, desc_style),
            spacer_row(),
            ...
            key_row("s", "Start container", key_style, desc_style),
