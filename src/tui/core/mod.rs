...
pub enum ContainerMessage {
    PaneChanged(crate::tui::views::detail_panel::DetailPane),
}
    ...
    ($self:ident, $key:ident, $comps_macro:ident) => {{
        match $key.code {
            ::crossterm::event::KeyCode::Tab => {
                $self.next();
                return $crate::tui::core::EventResult::Consumed;
            }
        ...
        if $self.focus.active_idx < comps.len() {
            ...
            match res {
                $crate::tui::core::EventResult::FocusNext => {
                    $self.next();
                    $crate::tui::core::EventResult::Consumed
                }
                $crate::tui::core::EventResult::FocusPrev => {
                    $self.prev();
                    $crate::tui::core::EventResult::Consumed
                }
                _ => res,
            ...
            $crate::tui::core::EventResult::Ignored
        }
    }};
}
