...
fn render_title(f: &mut Frame, app: &App, area: Rect) {
    ...
    let badge = match app.permissions.level() {
        crate::composition::PermissionLevel::Root => Span::styled(
            " [ ROOT ] ",
            Style::default()
                .fg(t.badge_root)
...
fn render_content(f: &mut Frame, app: &mut App, area: Rect) {
    ...
    let resize_mode = app.ui.resize_mode == crate::tui::app::ResizeMode::Active;
    ...
    if let Some(terminal_area) = terminal_area {
        let terminal_panel = crate::tui::views::terminal_panel::TerminalPanel;
...
fn render_status(f: &mut Frame, app: &App, area: Rect) {
    ...
    let line = if let Some((msg, level)) = &app.ui.status_message {
    ...
    } else if app.ui.resize_mode == crate::tui::app::ResizeMode::Active {
        ...
        match app.ui.focus {
            ...
            WorkspaceFocus::MachineInspector | WorkspaceFocus::ImageInspector => {
                let pane_hint = match crate::tui::views::detail_panel::DetailPane::tabs_for(
