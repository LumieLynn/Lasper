...
macro_rules! form_dialog {
    ($name:ident, $title:expr, ($hp:expr, $wp:expr), [ $( $field:ident ),+ $(,)? ]) => {
        ...
        impl crate::tui::core::Component for $name {
            fn render(
                &mut self,
                f: &mut ratatui::Frame,
                area: ratatui::layout::Rect,
            ) {
                let dialog_area = crate::tui::centered_rect($hp, $wp, area);
                ...
                let block = ratatui::widgets::Block::default()
                    ...
                    .border_style(ratatui::style::Style::default().fg(
                        crate::tui::theme::theme().dialog_border,
                    ));
            ...
            fn handle_key(&mut self, key: crossterm::event::KeyEvent) -> crate::tui::core::EventResult {
                use crate::tui::core::{AppMessage, EventResult, WizardMessage};
