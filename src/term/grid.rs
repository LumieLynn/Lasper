...
#![allow(clippy::as_conversions, clippy::pedantic, dead_code)]
...
impl Grid {
    ...
    pub fn set_size(&mut self, size: Size) {
        ...
        let max_rows = self.rows.len() - self.size.height as usize + self.used_rows as usize;
        ...
        self.scrollback_offset =
            (self.rows.len().saturating_sub(size.height as usize)).min(self.scrollback_offset);
        ...
        self.pos.row = u16::try_from(abs_pos_row.saturating_sub(self.row0())).unwrap_or_default();
...
pub fn scroll_offset(selected: usize, item_count: usize, viewport_height: usize) -> usize {
